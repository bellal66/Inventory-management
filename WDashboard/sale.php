  ...
  <div class="row content">
    ...
    <div class="main-body">
     <div class="col-sm-9">
       ...
       ?>
     <!-- Sales -->
     <div style="position: absolute; top: 10px; left: 10px; width: 1015px; height: 930px; background-color: green" id="add">
      <h4 style="text-align: center; color: white;">Makes Sales</h4>
      <div style="position: absolute; top: 40px; left: 15px; width: 985px; height: 875px; background-color: #eee;">
        <style>
        ...
        input[type=text], input[type=password] {
         ...
         hr {
          ...
          .registerbtn {
           ...
           <form action="sale_memo.php" method="post" target="_blank">
           ...
           <!-- form no 2 -->
            ...
            <!-- final money of form -->
              ...
              <tfoot>
                ...
                <button type="submit" class="registerbtn" name="sale" style="background-color: green">Submit Sale</button>
