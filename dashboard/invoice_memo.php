...
include '../database.php';
  ...
  $getbillno = mysql_query("SELECT * FROM  invoice");
  while($row = mysql_fetch_array($getbillno)){
  $oldbillno = $row['bill_no'];}
  $newbillno = $oldbillno + 1;

  $insert= mysql_query("INSERT into invoice(bill_no, name, address, datee, amount, type, owing_money, amount_buying, shopcode) values ('$newbillno','$customer_name','$address','$date','$final_total','$type','$final_total','$final_buying','$codeshop')");
...
<body>
   ...
   <div style="position: absolute; top: 38px; left: 430px; width: 300px; height: 50px;">
	  ...
	  <tr style="padding-left: 20px;">
	    <th style="border-style: groove;text-align: center;"><?php echo $date; ?></th>
		<th style="border-style: groove;text-align: center;"><?php echo $newbillno; ?></th>
   ...
   <div style="position: absolute; top: 193px; left: 30px; width: 650px; height: 420px;">
   ...
   <div style="position: absolute; top: 620px; left: 30px; width: 650px; height: 150px;">
