    ...
    <div class="main-body">
     <div class="col-sm-9">
      <button style="position: absolute; left: 0;top: 90px;background-color: white; border: 1px solid white;" onclick="printContent('print')">p</button>
       ...
       <p style="margin-top: 10px;"><a href="shop_product_history.php"><b>Back<<</b></a></p>
       ...
       <div class="product_list">
         ...
         <div id="print">
           <table style="width: 100%; height: 100%;" id="customers">
            ...
            <?php 
              $getprolist = mysql_query("SELECT * FROM  sale_itemcode WHERE shopcode='$codeshop' AND type='bill' AND type_no='$type_no' LIMIT 1");
